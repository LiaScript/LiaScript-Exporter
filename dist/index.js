var $1cMJR$xhr2 = require("xhr2");
var $1cMJR$path = require("path");
var $1cMJR$fsextra = require("fs-extra");
var $1cMJR$minimist = require("minimist");
var $1cMJR$temp = require("temp");
var $1cMJR$liascriptsimplescormpackager = require("@liascript/simple-scorm-packager");
var $1cMJR$puppeteer = require("puppeteer");
...
})($6dfbad0dbd15a2d9$exports);


'use strict';


function $cd9b4ea5a93bb666$export$6b76988456c0292f() {
    return new Promise((resolve, reject)=>{
        $1cMJR$temp.mkdir('lia', function(err, tmpPath) {
...
function $cd9b4ea5a93bb666$export$552bfb764b5cd2b4(filename, content) {
    return new Promise((resolve, reject)=>{
        $1cMJR$fsextra.writeFile(filename, content, function(err) {
            if (err) reject(err);
            else resolve('ok');
        });
    });
}
function $cd9b4ea5a93bb666$export$3032dc2899b8ea9b(src, dest) {
...
function $cd9b4ea5a93bb666$export$31a09876afc8115c(key, into) {
    return $cd9b4ea5a93bb666$export$a976684a0efeb93f(`<script src="https://code.responsivevoice.org/responsivevoice.js?key=${key}"></script>`, into);
}
function $cd9b4ea5a93bb666$export$a976684a0efeb93f(element, into) {
    return into.replace('</head>', element + '</head>');
}
function $cd9b4ea5a93bb666$export$bab98af026af71ac(uri) {
...
async function $4044c471004eafd2$export$372e2d09604f52f0(argument, json) {
    // make temp folder
    let tmp = await $cd9b4ea5a93bb666$export$6b76988456c0292f();
    let tmpPath = $1cMJR$path.join(tmp, 'pro');
    // copy assets to temp
    await $1cMJR$fsextra.copy($1cMJR$path.join(__dirname, './assets/web'), tmpPath);
    let index = $1cMJR$fsextra.readFileSync($1cMJR$path.join(tmpPath, 'index.html'), 'utf8');
    // change responsive key
    if (argument.key) index = $cd9b4ea5a93bb666$export$31a09876afc8115c(argument.key, index);
    // add default course
    index = $cd9b4ea5a93bb666$export$a976684a0efeb93f(`<script>
  if (!window.LIA) {
    window.LIA = {}
  }
  window.LIA.defaultCourse="${$1cMJR$path.basename(argument.readme)}"
  </script>`, index);
    try {
    ...
    try {
        ...
        index = $cd9b4ea5a93bb666$export$a976684a0efeb93f(`<meta property="og:image" content="${logo}"><meta name="twitter:image" content="${logo}">`, index);
        console.log('updating logo ...');
    } catch (e2) {
        console.warn('could not add image');
    }
    try {
        await $cd9b4ea5a93bb666$export$552bfb764b5cd2b4($1cMJR$path.join(tmpPath, 'index.html'), index);
    } catch (e3) {
        console.warn(e3);
        return;
    }
    // copy base path or readme-directory into temp
    await $1cMJR$fsextra.copy(argument.path, tmpPath);
    await $1cMJR$fsextra.move(tmpPath, argument.output, {
        filter: $cd9b4ea5a93bb666$export$3032dc2899b8ea9b
    });
}
...
async function $e66cfe93f93dd228$export$372e2d09604f52f0(argument, json) {
    // make temp folder
    let tmp = await $cd9b4ea5a93bb666$export$6b76988456c0292f();
    let tmpPath = $1cMJR$path.join(tmp, 'pro');
    // copy assets to temp
    await $1cMJR$fsextra.copy($1cMJR$path.join(__dirname, './assets/scorm1.2'), tmpPath);
    let index = $1cMJR$fsextra.readFileSync($1cMJR$path.join(tmpPath, 'index.html'), 'utf8');
    // change responsive key
    if (argument.key) index = $cd9b4ea5a93bb666$export$31a09876afc8115c(argument.key, index);
    index = $cd9b4ea5a93bb666$export$a976684a0efeb93f('<script src="config.js"></script>', index);
    await $cd9b4ea5a93bb666$export$552bfb764b5cd2b4($1cMJR$path.join(tmpPath, 'config.js'), 'window.config_ = ' + JSON.stringify({
        task: json.task,
        quiz: json.quiz,
        survey: json.survey
    }) + ';');
    ...
    let config = {
        ...
        source: $1cMJR$path.join(tmp, 'pro'),
        package: {
            version: json.lia.definition.version,
            zip: true,
            appendTimeToOutput: false,
            name: $1cMJR$path.basename(argument.output),
            author: json.lia.definition.author,
            outputFolder: $1cMJR$path.dirname(argument.output),
            filename: $1cMJR$path.basename(argument.output + '.zip'),
    ...
    $1cMJR$liascriptsimplescormpackager(config, function(msg) {
        console.log(msg);
        process.exit(0);
    });
}
...
async function $61c57cb861b9cecd$export$372e2d09604f52f0(argument, json) {
    // make temp folder
    let tmp = await $cd9b4ea5a93bb666$export$6b76988456c0292f();
    let tmpPath = $1cMJR$path.join(tmp, 'pro');
    // copy assets to temp
    await $1cMJR$fsextra.copy($1cMJR$path.join(__dirname, './assets/scorm2004'), tmpPath);
    let index = $1cMJR$fsextra.readFileSync($1cMJR$path.join(tmpPath, 'index.html'), 'utf8');
    // change responsive key
    if (argument.key) index = $cd9b4ea5a93bb666$export$31a09876afc8115c(argument.key, index);
    index = $cd9b4ea5a93bb666$export$a976684a0efeb93f('<script src="config.js"></script>', index);
...
async function $1b958fb009a5413a$export$372e2d09604f52f0(argument, json) {
    let url = `file://${__dirname}/assets/pdf/index.html?`;
    if ($cd9b4ea5a93bb666$export$bab98af026af71ac(argument.input)) url += argument.input;
    else url += 'file:///' + $1cMJR$path.resolve(__dirname + '/../', argument.input);
    const browser = await $1cMJR$puppeteer.launch({
        args: [
    ...
    if (argument['pdf-stylesheet']) {
        const href1 = $1cMJR$path.resolve(__dirname + '/../', argument['pdf-stylesheet']);
...
$parcel$global.XMLHttpRequest = $1cMJR$xhr2;



const $3390e11c3e52170f$var$argv = $1cMJR$minimist(process.argv.slice(2));
// -------------------------------Main Execution-------------------------------
if ($3390e11c3e52170f$var$argv.v || $3390e11c3e52170f$var$argv.version) console.log('version: 1.0.51--0.9.51');
else if ($3390e11c3e52170f$var$argv.h || $3390e11c3e52170f$var$argv.help) $3390e11c3e52170f$var$help();
else if ($3390e11c3e52170f$var$argv.i || $3390e11c3e52170f$var$argv.input) $3390e11c3e52170f$var$run($3390e11c3e52170f$var$parseArguments());
else {
    console.warn('No input defined');
    $3390e11c3e52170f$var$help();
}
// ----------------------------------------------------------------------------
function $3390e11c3e52170f$var$run(argument) {
    var app = $6dfbad0dbd15a2d9$exports.Elm.Worker.init({
        flags: {
            cmd: ''
        }
    });
    app.ports.output.subscribe(function(event) {
        ...
        switch(argument.format){
            case 'json':
            case 'fulljson':
                $1cMJR$fsextra.writeFile(argument.output + '.json', string, function(err) {
                    if (err) console.error(err);
                });
                break;
            case 'scorm1.2':
                $e66cfe93f93dd228$export$372e2d09604f52f0(argument, JSON.parse(string));
                break;
            case 'scorm2004':
                $61c57cb861b9cecd$export$372e2d09604f52f0(argument, JSON.parse(string));
                break;
            case 'web':
                $4044c471004eafd2$export$372e2d09604f52f0(argument, JSON.parse(string));
                break;
            case 'pdf':
                $1b958fb009a5413a$export$372e2d09604f52f0(argument, JSON.parse(string));
                break;
            default:
    ...
    try {
        ...
        if (!$cd9b4ea5a93bb666$export$bab98af026af71ac(argument.input)) {
            const data = $1cMJR$fsextra.readFileSync(argument.input, 'utf8');
            app.ports.input.send([
                format,
                data
            ]);
        } else if (argument.format === 'pdf') $1b958fb009a5413a$export$372e2d09604f52f0(argument, {
        });
...
function $3390e11c3e52170f$var$help() {
...
function $3390e11c3e52170f$var$parseArguments() {
    const argument = {
        input: $3390e11c3e52170f$var$argv.i || $3390e11c3e52170f$var$argv.input,
        readme: $3390e11c3e52170f$var$argv.i || $3390e11c3e52170f$var$argv.input,
        output: $3390e11c3e52170f$var$argv.o || $3390e11c3e52170f$var$argv.output || 'output',
        format: $3390e11c3e52170f$var$argv.f || $3390e11c3e52170f$var$argv.format || 'json',
        path: $3390e11c3e52170f$var$argv.p || $3390e11c3e52170f$var$argv.path,
        key: $3390e11c3e52170f$var$argv.k || $3390e11c3e52170f$var$argv.key,
        // special cases for SCORM
        organization: $3390e11c3e52170f$var$argv.organization,
        masteryScore: $3390e11c3e52170f$var$argv.masteryScore,
        typicalDuration: $3390e11c3e52170f$var$argv.typicalDuration,
        // pdf cases
        'pdf-preview': $3390e11c3e52170f$var$argv['pdf-preview'],
        'pdf-scale': $3390e11c3e52170f$var$argv['pdf-scale'],
        'pdf-displayHeaderFooter': $3390e11c3e52170f$var$argv['pdf-displayHeaderFooter'],
        'pdf-headerTemplate-date': $3390e11c3e52170f$var$argv['pdf-headerTemplate-date'],
        'pdf-headerTemplate-title': $3390e11c3e52170f$var$argv['pdf-headerTemplate-title'],
        'pdf-headerTemplate-url': $3390e11c3e52170f$var$argv['pdf-headerTemplate-url'],
        'pdf-headerTemplate-pageNumber': $3390e11c3e52170f$var$argv['pdf-headerTemplate-pageNumber'],
        'pdf-headerTemplate-totalPages': $3390e11c3e52170f$var$argv['pdf-headerTemplate-totalPages'],
        'pdf-footerTemplate': $3390e11c3e52170f$var$argv['pdf-footerTemplate'],
        'pdf-printBackground': $3390e11c3e52170f$var$argv['pdf-printBackground'],
        'pdf-landscape': $3390e11c3e52170f$var$argv['pdf-landscape'],
        'pdf-format': $3390e11c3e52170f$var$argv['pdf-format'],
        'pdf-width': $3390e11c3e52170f$var$argv['pdf-width'],
        'pdf-height': $3390e11c3e52170f$var$argv['pdf-height'],
        'pdf-margin-top': $3390e11c3e52170f$var$argv['pdf-margin-top'],
        'pdf-margin-bottom': $3390e11c3e52170f$var$argv['pdf-margin-bottom'],
        'pdf-margin-right': $3390e11c3e52170f$var$argv['pdf-margin-right'],
        'pdf-margin-left': $3390e11c3e52170f$var$argv['pdf-margin-left'],
        'pdf-preferCSSPageSize': $3390e11c3e52170f$var$argv['pdf-preferCSSPageSize'],
        'pdf-omitBackground': $3390e11c3e52170f$var$argv['pdf-omitBackground'],
        'pdf-timeout': $3390e11c3e52170f$var$argv['pdf-timeout'],
        'pdf-stylesheet': $3390e11c3e52170f$var$argv['pdf-stylesheet']
    };
    argument.format = argument.format.toLowerCase();
    if (!argument.path && !$cd9b4ea5a93bb666$export$bab98af026af71ac(argument.input)) {
        argument.path = $1cMJR$path.dirname(argument.input);
        argument.readme = $1cMJR$path.basename(argument.input);
    }
    return argument;
}
